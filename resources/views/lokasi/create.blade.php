        ...
        <div class="card-body">
          <form action="{{ route('lokasi.store') }}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Universitas Nahdlatul Ulama Kaltim">
              @error('nama')
            ...
            <div class="form-group row">
              <div class="col">
                <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" placeholder="Latitude Position">
                @error('latitude')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="col">
                <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" placeholder="Longitude Position">
                @error('longitude')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
